...
CASE_CLASSIFICATION_MAP = {
    "1": "LNG_REFERENCE_DATA_CATEGORY_CASE_CLASSIFICATION_CONFIRMED", 
    "2": "LNG_REFERENCE_DATA_CATEGORY_CASE_CLASSIFICATION_CONFIRMED", 
    "3": "LNG_REFERENCE_DATA_CATEGORY_CASE_CLASSIFICATION_NOT_A_CASE_DISCARDED", 
    "":  "LNG_REFERENCE_DATA_CATEGORY_CASE_CLASSIFICATION_SUSPECT"
}
        
OUTCOME_MAP = {
    "1": "LNG_REFERENCE_DATA_CATEGORY_OUTCOME_RECOVERED",
    "2": "LNG_REFERENCE_DATA_CATEGORY_OUTCOME_OBITOS_POR_DOENCAS_EXANTEMATICAS",
    "3": "LNG_REFERENCE_DATA_CATEGORY_OUTCOME_OBITO_POR_OUTRAS_CASAS",
    "9": "LNG_REFERENCE_DATA_CATEGORY_OUTCOME_ALIVE",
}

# Mapeamento entre os campos do questionário e as colunas do SINAN
QUESTIONNAIRE_MAP = {
